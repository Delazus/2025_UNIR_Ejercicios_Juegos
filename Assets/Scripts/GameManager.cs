...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private LifeSystem sistemaVidasJugador;
    ...
    private void Start()
    {
        ...
        if (iniciarDirecto)
        {
            ...
            // Important?simo: reseteamos el flag
    ...
    private void CacheSistemaVidasJugador()
    {
        ...
        LifeSystem[] vidasEncontradas = player.GetComponentsInChildren<LifeSystem>(true);
